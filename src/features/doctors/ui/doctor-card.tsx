  ...
  return (
    <>
      ...
      >
        <Card
          hoverable
          className="w-full h-full transition-all duration-200 hover:shadow-xl border-none bg-gradient-to-br from-white to-gray-50/50 backdrop-blur-sm rounded-2xl"
        >
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="mt-6 space-y-4">
                  <motion.div
                    whileHover={{ x: 5 }}
                    className="flex items-center gap-3 group bg-gradient-to-br from-gray-50 to-transparent p-3 rounded-xl"
                  >
